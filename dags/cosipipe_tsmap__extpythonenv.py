...
# Create the DAG
dag = DAG(
    'cosipipe_tsmap__extpythonenv',
    default_args=default_args,
    description='COSI TS Map computation pipeline',
    schedule_interval=None,  # Manual trigger only
    catchup=False,
    tags=['cosipy', 'tsmap', 'grb', 'extpythonenv'],
)
...
# data_aggregation >> [ts_map_computation, multi_resolution_ts_map]
# [ts_map_computation, multi_resolution_ts_map] >> cleanup

contact_simulator >> [bin_grb_data, bin_background]
[bin_grb_data, bin_background] >> data_aggregation
data_aggregation >> multi_resolution_ts_map
multi_resolution_ts_map >> cleanup
