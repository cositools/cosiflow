...
class DataPipeline:
	...
	def check_new_file_sensor(self):
		input_files = os.listdir(f'{self.base_dir}/input')
...
with DAG('cosi_data_analysis_pipeline_v2', default_args={'owner': 'airflow'}, schedule=None, 
		start_date=datetime.now(),
		max_active_tasks=5,  # Numero massimo di task eseguibili contemporaneamente per DAG
	...
	wait_for_new_file_sensor = PythonSensor(
        task_id='wait_for_new_file_sensor',
	...
	wait_for_new_file_sensor >> ingest_and_store_dl0_task_sensor >> generate_dl1a_task >> generate_dl1b_task >> generate_dl1c_task >> generate_dl2_task >> [fast_transient_stage_one_task, fast_transient_stage_two_task]
	fast_transient_stage_two_task >> fast_transient_stage_three_task
